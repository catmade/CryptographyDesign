...
namespace CryptographyDesign.Cipher
{
    ...
    public class HillCipher : ICipher<List<char>, List<char>>
    {
        ...
        public bool IsPlainSuitable(List<char> plain, out string message, out string sender)
        {
            throw new NotImplementedException();
        }

        public bool IsCipherSuitable(List<char> cipher, out string message, out string sender)
        {
            throw new NotImplementedException();
        }
